...
layer=12
n_clusters=1024
ckpt_path=pretrained_model/hubert/hubert_large_ll60k.pt
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
    OMP_NUM_THREADS=1 OPENBLAS_NUM_THREADS=1 python3 ${BIN_DIR}/learn_kmeans.py \
        ...
        --km_path=${root_dir}/dump_libritts/libritts_${sub_dataset_name}/hubert_large_ll60k_L${layer}_km${n_clusters}.bin
fi
