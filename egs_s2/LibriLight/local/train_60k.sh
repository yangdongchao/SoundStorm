...
OMP_NUM_THREADS=${omp_num} python3 ${BIN_DIR}/train_librilight_60k.py \
        ...
        --train_acoustic_dirs ''${root_dir}'/'${dump_dir}'/small/train/acoustic_token/' ''${root_dir}'/'${dump_dir}'/medium/train/acoustic_token/' ''${root_dir}'/'${dump_dir}'/large/train/acoustic_token/' ''${root_dir}'/'${dump_dir}'/duplicate/train/acoustic_token/' \
        ...
        --dev_acoustic_dirs ''${root_dir}'/'${dump_dir}'/small/dev/acoustic_token/' ''${root_dir}'/'${dump_dir}'/medium/dev/acoustic_token/' ''${root_dir}'/'${dump_dir}'/large/dev/acoustic_token/' ''${root_dir}'/'${dump_dir}'/duplicate/dev/acoustic_token/' \
