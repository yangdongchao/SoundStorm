...
sys.path.append("..")
from sound_synthesis.taming.models.vqgan import GumbelVQ, VQModel
from sound_synthesis.taming.models.cond_transformer import Net2NetTransformer
...
class TamingFFHQVQVAE(BaseCodec):
    def __init__(
        ...
        if self.quantize_number != 0 and mapping_path is not None:
