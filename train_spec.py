...
from sound_synthesis2.utils.misc import seed_everything, merge_opts_to_config, modify_config_for_debug
...
def get_args():
    ...
    parser.add_argument('--output', type=str, default='SoundStorm/OUTPUT', 
