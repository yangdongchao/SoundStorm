...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path", default='../hubert_checkpoint/hubert_base_ls960.pt')
    parser.add_argument("--layer", type=int, default=10)
    parser.add_argument("--nshard", type=int, default=5)
    parser.add_argument("--rank", type=int, default=0)
    parser.add_argument("--feat_dir", default='../data/libritts_train_clean_360/semantic_feature')
